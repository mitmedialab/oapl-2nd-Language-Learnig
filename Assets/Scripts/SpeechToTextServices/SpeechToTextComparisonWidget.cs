...
namespace opal
{
    ...
    public class SpeechToTextComparisonWidget : MonoBehaviour
    {
        ...
        void RegisterSpeechToTextServiceWidgetsCallbacks()
        {
            ...
            {
				Logger.Log( "register service widgets callbacks");
                foreach (var serviceWidget in m_SpeechToTextServiceWidgets)
                {
					Logger.Log( "register service widget callbacks");
        ...
        void UnregisterSpeechToTextServiceWidgetsCallbacks()
        {
            if (m_SpeechToTextServiceWidgets != null)
            {
				Logger.Log( "unregister service widgets callbacks");
                foreach (var serviceWidget in m_SpeechToTextServiceWidgets)
                {
					Logger.Log("unregister service widget callbacks");
        ...
        {
			Logger.Log ("on record button clicked...");
            if (m_IsRecording)
            {
                StopRecording();
            }
        ...
        void StartRecording()
        {
            if (!m_IsRecording)
            {
				Logger.Log("Start comparison recording");
				...
				Logger.Log ("service widget size: "+m_SpeechToTextServiceWidgets.Length);
				foreach (var serviceWidget in m_SpeechToTextServiceWidgets) {
					
					Logger.Log ("tell service widget to start recording");
