...
namespace opal
{
    ...
    public static class IOUtilities
    {
        ...
        {
            Logger.Log( "original path: " + filePath);
            if (File.Exists(filePath))
            {
				...
				Logger.Log( "original path extension: " + fileExtension);
				Logger.Log( "original path without extension: " + filePath);
                ...
                if (filePathIsUnique)
                {
					...
					Logger.Log( "new path: " + newFilePath);
                }
                else
                {
                    return null;
